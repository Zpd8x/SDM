...
$PortableStage = Join-Path $Root 'build\portable\SDM_v3.2.0_Portable_x64'
...
$PortableZip = Join-Path $Release 'SDM_v3.2.0_Portable_x64.zip'
...
$ExtensionZip = Join-Path $Release 'SDM_Browser_Extension_v3.2.0.zip'
